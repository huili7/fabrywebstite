...
<p>For more information, and sample image files see <a href="http://www.libpng.org/pub/png/colorcube/gamma-consistency-test.php">http://www.libpng.org/pub/png/colorcube/gamma-consistency-test.php</a></p>
...
<p>The image below is taken from <a href="http://www.w3.org/TR/CSS21/intro.php">http://www.w3.org/TR/CSS21/intro.php</a> and has the gAMA value set to 1.45454   This is probably unintentional and should be 0.45454 which is 1 / 2.2</p>
<p>The image appears differently on IE9/Safari versus Firefox/Opera. To quote from http://www.libpng.org/pub/png/spec/1.2/PNG-Encoders.php "If the source file\'s gamma value is greater than 1.0, it is probably a display system exponent,....and you should use its reciprocal for the PNG gamma."
